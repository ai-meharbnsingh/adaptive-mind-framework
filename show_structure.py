...
def generate_tree(directory=".", prefix="", ignore_patterns=None, max_depth=5, current_depth=0):
    ...
    for i, item in enumerate(items):
        ...
        if item.is_dir():
            ...
            subtree = generate_tree(item, prefix + extension_prefix, ignore_patterns, max_depth, current_depth + 1)
            tree_lines.extend(subtree)

    return tree_lines


def create_structure_file(target_directory=".", output_filename="project_structure.txt", max_depth=5):
